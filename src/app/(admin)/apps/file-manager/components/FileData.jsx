            ...
            <td>
              <Dropdown className="dropdown flex-shrink-0 text-muted">
                ...
                <DropdownMenu className="dropdown-menu-end">
                  ...
                  <DropdownItem href={avatar1.src} download><IconifyIcon icon='ri:download-line' className="me-1" />
      ...
      {/* <tr>
        <td className="ps-3">
          <div className="d-flex align-items-center gap-2">
            ...
            <div>
              <span className="fw-medium"><a href="javascript: void(0);" className="text-reset">ocen-dashboard.pdf</a></span>
          ...
          <div className="d-flex align-items-center gap-2">
            <div>
              <a href="javascript: void(0);">
                <Image src={avatar2} className="rounded-circle avatar-md" alt="friend" />
              </a>
            </div>
            <div>
       ...
       <tr>
        <td className="ps-3">
          <div className="d-flex align-items-center gap-2">
            ...
            <div>
              <span className="fw-medium"><a href="javascript: void(0);" className="text-reset">Dashboard tech
                requirements</a></span>
       ...
       <tr>
        <td className="ps-3">
          <div className="d-flex align-items-center gap-2">
            ...
            <div>
              <span className="fw-medium"><a href="javascript: void(0);" className="text-reset">dashboard.jpg</a></span>
       ...
       <tr>
        <td className="ps-3">
          <div className="d-flex align-items-center gap-2">
            ...
            <div>
              <span className="fw-medium"><a href="javascript: void(0);" className="text-reset">admin-hospital.zip</a></span>
       ...
       <tr>
        <td className="ps-3">
          <div className="d-flex align-items-center gap-2">
            ...
            <div>
              <span className="fw-medium"><a href="javascript: void(0);" className="text-reset">Project-summary.pdf</a></span>
       ...
       <tr>
        <td className="ps-3">
          <div className="d-flex align-items-center gap-2">
            ...
            <div>
              <span className="fw-medium"><a href="javascript: void(0);" className="text-reset">Sales-data.xlsx</a></span>
       ...
       <tr>
        <td className="ps-3">
          <div className="d-flex align-items-center gap-2">
            ...
            <div>
              <span className="fw-medium"><a href="javascript: void(0);" className="text-reset">Presentation-slides.pptx</a></span>
       ...
       <tr>
        <td className="ps-3">
          <div className="d-flex align-items-center gap-2">
            ...
            <div>
              <span className="fw-medium"><a href="javascript: void(0);" className="text-reset">Readme.txt</a></span>
       ...
       <tr>
        <td className="ps-3">
          <div className="d-flex align-items-center gap-2">
            ...
            <div>
              <span className="fw-medium"><a href="javascript: void(0);" className="text-reset">Team-photo.jpg</a></span>
