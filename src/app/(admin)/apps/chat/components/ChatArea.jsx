  ...
  return <li className={clsx('chat-group', {
    odd: message.from.id === toUser.id
      ...
      {message.from.id != toUser.id && <div className="chat-avatar text-center">
          {message.from.image && <Image src={message.from.image} alt="avatar" className="avatar-sm rounded-circle" />}
        </div>}
      ...
      <CardHeader className="py-2 px-3 border-bottom">
        <div className="d-flex align-items-center justify-content-between py-1">
          <div className="d-flex align-items-center gap-2">
            ...
            {selectedUser?.image && <Image src={selectedUser.image} className="avatar-lg rounded-circle" alt='avatar' />}
            ...
            <div>
              <h5 className="my-0 lh-base">
                <Link href="" className="text-reset">James Zavel</Link>
              </h5>
          ...
          <div className="d-flex align-items-center gap-2">
            <Link href="" className="btn btn-sm btn-icon btn-ghost-light d-none d-xl-flex" data-bs-toggle="modal" data-bs-target="#userCall" data-bs-placement="top" title="Voice Call">
              <IconifyIcon icon='tabler:phone-call' className="fs-20" />
            </Link>
            <Link href="" className="btn btn-sm btn-icon btn-ghost-light d-none d-xl-flex" data-bs-toggle="modal" data-bs-target="#userVideoCall" data-bs-placement="top" title="Video Call">
          ...
          <form className="row align-items-center g-2" name="chat-form" id="chat-form" onSubmit={handleSubmit(sendChatMessage)}>
            ...
            <Col sm={'auto'}>
              <div className="d-flex align-items-center gap-1">
                ...
                <Link href="" className="btn btn-icon btn-soft-primary"><IconifyIcon icon="tabler:microphone" /> </Link>
                <Link href="" className="btn btn-icon btn-soft-primary"><IconifyIcon icon="tabler:paperclip" /></Link>
              </div>
            </Col>
          </form>
        </div>
