  ...
  return <Card>
      <CardBody>
        ...
        <div className="d-flex align-items-top mb-2">
          <Image src={avatar1} alt='avatar1' className="flex-shrink-0 comment-avatar avatar-sm rounded me-2" />
          <div className="flex-grow-1">
            ...
            <div>
              <a href=''>
                <Image alt='' src={small1} className="avatar-md rounded" />
              </a>&nbsp;
              <a href=''>
                <Image alt='' src={small2} className="avatar-md rounded" />
              </a>&nbsp;
              <a href=''>
                <Image alt='' src={small3} className="avatar-md rounded" />
              </a>
            </div>
            ...
            <div className="d-flex align-items-top mb-2">
              <Image src={avatar3} alt='avatar3' className="flex-shrink-0 comment-avatar avatar-sm rounded me-2" />
              <div className="flex-grow-1">
            ...
            <div className="d-flex align-items-top">
              <Image src={avatar4} alt='avatar4' className="flex-shrink-0 comment-avatar avatar-sm rounded me-2" />
              <div className="flex-grow-1">
                ...
                <div className="d-flex align-items-top mb-2">
                  <Image src={avatar5} alt='avatar5' className="flex-shrink-0 comment-avatar avatar-sm rounded me-2" />
                  <div className="flex-grow-1">
        ...
        <div className="d-flex align-items-top mb-3">
          <Image src={avatar6} alt='avatar6' className="flex-shrink-0 comment-avatar avatar-sm rounded me-2" />
          <div className="flex-grow-1">
        ...
        <div className="d-flex align-items-top mb-3">
          <Image src={avatar7} alt='avatar7' className="flex-shrink-0 comment-avatar avatar-sm rounded me-2" />
          <div className="flex-grow-1">
