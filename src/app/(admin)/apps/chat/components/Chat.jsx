        ...
        <div className="d-flex align-items-center gap-2 py-1">
          <div className="chat-users">
            <div className="avatar-lg chat-avatar-online">
              <Image src={avatar1} className="img-fluid rounded-circle" alt="Chris Keller" />
            </div>
          </div>
          <div className="flex-grow-1">
            <h5 className="mb-0">
              <Link href="" className="text-reset lh-base">Dhanoo K.</Link>
            </h5>
          ...
          {users?.map((item, idx) => <Fragment key={idx}>
              ...
              onUserSelect(item);
                    ...
                    <div className="avatar-md chat-avatar-offline">
                      {item.image && <Image src={item.image} className="img-fluid rounded-circle" alt="Brandon Smith" />}
